...
CREATE TABLE memories (
  ...
  source TEXT CHECK (source IN ('slack', 'teams', 'notion', 'github', 'gdrive', 'email', 'jira', 'voice', 'conversation', 'manual')) DEFAULT 'manual',
...
CREATE TABLE integrations (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  provider TEXT CHECK (provider IN ('slack', 'teams', 'github', 'notion', 'google_drive', 'jira', 'email')) UNIQUE NOT NULL,
